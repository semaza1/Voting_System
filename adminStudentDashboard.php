...
<head>
    ...
    <title>Voted Student List</title>
</head>
<body>
    <section class="mainContainer">
        ...
        <div class="heroSection">
            <div class="rightNavBar">
                <h1 style="font-family: 'Poppins', sans-serif; font-weight: 700; font-style: normal; color: #48805F; font-size: 1.7rem;">List of Student who voted</h1>
                <div class="notProf">
                   ...
                   <a href="#"><p onclick="showPopup()" style="font-size: 12px; cursor: pointer;">Add new Student</p></a>
                </div>
            </div>
    ...
    <div id="popBackground">
        <div class="container">
            <div class="addPos">
                ...
                <form action="">
                    <h1 style="font-size: 20px; color: #48805F;">Add a student</h1>
                    <div class="inputbox">
                        <input type="text" required>
                        <label for="" id="label">Student ID</label>
                    </div>
                    <button onclick="hidePopup()" style="margin-top: 7rem;">Add a Student</button>
                </form>
            </div>
        </div> 
    </div>
