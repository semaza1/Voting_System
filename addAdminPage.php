...
<head>
    ...
    <link rel="stylesheet" href="addAdminPage.css">
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link rel="stylesheet" href="adminStudentDashboard.css">
    ...
    <section class="mainContainer">
        ...
        <div class="heroSection">
            <div class="rightNavBar">
                <h1 style="font-family: 'Poppins', sans-serif; font-weight: 700; font-style: normal; color: #48805F; font-size: 1.7rem;">Adminstrators</h1>
                <div class="notProf">
                    <svg style="cursor: pointer;" width="20px" height="20px" viewBox="0 0 512 512" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#eda246" stroke="#eda246"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <title>new-indicator-filled</title> <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"> <g id="scheduler" fill="#eda246" transform="translate(85.333333, 85.333333)"> <path d="M170.666667,1.42108547e-14 C264.923264,-3.10380131e-15 341.333333,76.4100694 341.333333,170.666667 C341.333333,264.923264 264.923264,341.333333 170.666667,341.333333 C76.4100694,341.333333 2.57539587e-14,264.923264 1.42108547e-14,170.666667 C2.6677507e-15,76.4100694 76.4100694,3.15255107e-14 170.666667,1.42108547e-14 Z M192,85.3333333 L149.333333,85.3333333 L149.333333,149.333333 L85.3333333,149.333333 L85.3333333,192 L149.333333,191.999333 L149.333333,256 L192,256 L191.999333,191.999333 L256,192 L256,149.333333 L191.999333,149.333333 L192,85.3333333 Z" id="Combined-Shape"> </path> </g> </g> </g></svg>
            ...
            <div class="table-container">
                <table>
                    ...
                    while($ans = mysqli_fetch_assoc($result)){
                        echo " <tr>";
                        echo "<td><img src=\"assets/{$ans['ProfileImg']}\" alt=\"admin\" height=\"50px\" width=\"50px\"/></td>";
                ...
                <div class="addAdmin">
                    ...
                    <form action="adminConn.php" method="POST">
                        ...
                        <div class="inputbox">
                            ...
                            <label for="" id="label">Names</label>
                        </div>
                        <div class="inputbox">
                            <input type="password" name="adminPswd" required>
                        ...
                        <div class="gender">
                            <div class="gender1"><input type="radio" value="Male" name="adminGender">Male</div> 
                            <div class="gender1"><input type="radio" value="Female" name="adminGender">0<label for="">Female</label></div>
                        </div>
                        <button onclick="hidePopup()" name="addAdmin">Add</button>
                    </form>
                </div>
            </div> 
        </div>
            <!-- end of it -->
            <script src="addAdminPage.js"></script>
</body>
</html>
</body>
</html>